// <copyright file="OtlpHttpLogsExportClient.cs" company="OpenTelemetry Authors">
...
{
    /// <summary>Class for sending OTLP Logs export request over HTTP.</summary>
    internal class OtlpHttpLogsExportClient : BaseOtlpHttpExportClient<OtlpCollector.ExportLogsServiceRequest>
    {
        internal const string MediaContentType = "application/x-protobuf";
        private readonly Uri exportLogssUri;

        public OtlpHttpLogsExportClient(OtlpExporterOptions options, HttpClient httpClient)
            : base(options, httpClient)
        {
            this.exportLogssUri = this.Endpoint;
        }

        protected override HttpRequestMessage CreateHttpRequest(OtlpCollector.ExportLogsServiceRequest exportRequest)
        {
            var request = new HttpRequestMessage(HttpMethod.Post, this.exportLogssUri);
